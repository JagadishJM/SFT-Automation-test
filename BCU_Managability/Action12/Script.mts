...
WshShell.SendKeys "{Enter}"
wait 4
Window("Commandpromt").CaptureBitmap "C:\CMIT\test1Biosvalue.png"
...
'-------------------4.After BCU creates test1.txt, open it and change value of an enumeration setting---------------------- 
'-------------------(e.g. Parallel  Port) to an invalid string (e.g. ' *Enaaaaaaable')-------------------------------------
'Dim fso 
Set fso = CreateObject("Scripting.FileSystemObject")
'Dim oFile 
...
strText=Replace (strText,"Enable","*Enaaaaaaable")
...
WshShell.SendKeys "{Enter}"
wait 2
Window("Commandpromt").CaptureBitmap "C:\CMIT\test3Biosvalue.png"
wait 2
WshShell.SendKeys "Exit"
wait 2
WshShell.SendKeys "{Enter}"
